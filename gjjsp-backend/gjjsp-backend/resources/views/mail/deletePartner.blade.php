...
<body>
    ...
    <div class="container">
        <h2>Deleted Project Partner</h2>
        <p>Dear {{ $user->first_name }}</p>
        <p>Project Partner {{ $deletedName }} has been deleted to the system if you wish to restore you can send an email to See So Support Team </p>
